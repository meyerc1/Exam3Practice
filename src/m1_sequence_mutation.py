...
def run_test_zero_changer():
    ...
    # Test 2:
    test1 = ([], [0, 1, 0, 2, 0], [1, 2, 3, 4, 5, 6], [3, 0, 5])
    expected1 = ([], [1, 1, 2, 2, 3], [1, 2, 3, 4, 5, 6], [3, 4, 5])
    zero_changer(test1)
    print()
    print('Test 2:')
    print('  Expected:', expected1)
    ...
    # Test 3:
    test1 = ([1, 2, 4], [0, 0, 0, (1 - 1), 6], [2, 4, 0], [5, 4, 0])
    expected1 = ([1, 2, 4], [1, 2, 3, 4, 6], [2, 4, 5], [5, 4, 6])
    zero_changer(test1)
    print()
    print('Test 2:')
    print('  Expected:', expected1)
...
def zero_changer(tuple_of_lists):
    ...
    """
    # ------------------------------------------------------------------
    # DONE: 3. sImplement and test this function.
